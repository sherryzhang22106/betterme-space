...
export const ASSESSMENTS: Assessment[] = [
  // 1. 情绪调节
  {
    ...
    icon: <Icons.Mood />,
    coverImage: 'https://images.unsplash.com/photo-1519751138087-5bf79df62d5b?q=80&w=1000&auto=format&fit=crop',
    count: '12.5w+',
    hot: true,
  ...
  },
  {
    ...
    title: '内耗指数',
    description: '扫描你的情绪黑洞，停止多余的内在精神消耗。',
    category: AssessmentCategory.MOOD,
    icon: <Icons.Mood />,
    count: '8.9w+',
  ...
  // 2. 人生探索
  {
    id: 'life-script',
    title: '人生剧本',
    description: '解锁你的核心人生脚本，改写未来的戏剧走向。',
    category: AssessmentCategory.LIFE,
    icon: <Icons.Life />,
    count: '15.2w+',
    hot: true,
  ...
  },
  {
    id: 'parallel-self',
    title: '平行宇宙的你',
    description: '探索生命的其他可能性，遇见另一个时空的自己。',
    category: AssessmentCategory.LIFE,
    icon: <Icons.Life />,
    isLocked: true,
    timeEstimate: '12 min',
  ...
  // 3. 情感实验室
  {
    id: 'love-health',
    title: '恋爱健康指数',
    description: '审视亲密关系的成色，量化互动中的“养分”分布。',
    category: AssessmentCategory.LOVE,
    icon: <Icons.Love />,
    count: '6.7w+',
    timeEstimate: '8 min',
    difficulty: '中等'
  ...
  {
    id: 'love-concentration',
    title: '爱情浓度',
    description: '量化当下的爱意深度，看看你们正处于哪个阶段。',
    category: AssessmentCategory.LOVE,
    icon: <Icons.Love />,
    count: '4.2w+',
    timeEstimate: '5 min',
  ...
  },
  {
    id: 'breakup-recovery',
    title: '分手挽回可能性',
    description: '理性的情感回溯评估，TA还值得你回头吗？',
    category: AssessmentCategory.LOVE,
    icon: <Icons.Love />,
    count: '24.1w+',
    timeEstimate: '15 min',
  ...
  },
  {
    id: 'attachment-style',
    title: '依恋风格',
    description: '深度挖掘你的内在安全感来源与互动模式。',
    category: AssessmentCategory.LOVE,
    icon: <Icons.Love />,
    count: '11.3w+',
    timeEstimate: '10 min',
