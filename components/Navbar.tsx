      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="relative">
            ...
            {showThemeMenu && (
              <div className="absolute top-full right-0 mt-2 w-40 bg-white rounded-2xl shadow-xl border border-slate-100 p-2 animate-in fade-in slide-in-from-top-2" onClick={(e) => e.stopPropagation()}>
                {themes.map(t => (
                  <button
                    key={t.id}
          ...
          {isLoggedIn() ? (
            <div className="relative">
              ...
              {showUserMenu && (
                <div className="absolute top-full right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-slate-100 p-2 animate-in fade-in slide-in-from-top-2" onClick={(e) => e.stopPropagation()}>
                  ...
                  <Link
                    to="/user"
                    className="flex items-center space-x-3 px-3 py-2 rounded-xl text-xs font-medium text-slate-600 hover:bg-slate-50 transition-colors"
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-xs font-medium text-rose-500 hover:bg-rose-50 transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to="/auth/login"
              className="flex items-center space-x-2 pl-4 border-l border-slate-100 text-sm font-medium text-slate-600 hover:text-brand-primary transition-colors"
            >
